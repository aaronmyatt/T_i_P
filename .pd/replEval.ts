...
const runStart = (input) => run(start, input);
...
const tracedExtractBlurb = (input) => traced(extractBlurb, input);
const runExtractFrontmatter = (input) => run(extractFrontmatter, input);
const testExtractFrontmatter = () => test(extractFrontmatter);
const stepExtractFrontmatter = () => step(extractFrontmatter);
const tracedExtractFrontmatter = (input) => traced(extractFrontmatter, input);
